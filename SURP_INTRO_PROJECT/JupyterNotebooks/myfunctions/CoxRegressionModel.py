...
#     aft.fit(df, duration_col='T', event_col='E', show_progress = True)

#     aft.print_summary(3) 
        
#     aft.plot_partial_effects_on_outcome(covariates = ['aps'], values = [[aps_0]], ax = axes, cmap = 'viridis')
#     cph.print_summary()


#     plt.title('Weibull AFT Fitter:(eb,ap,mu)={}'.format((round(ebs,3),round(aps_0,3),mu)), fontsize = 12)
